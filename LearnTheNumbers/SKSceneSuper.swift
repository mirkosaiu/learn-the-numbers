...
//    var mixpanel: Mixpanel = Mixpanel.sharedInstanceWithToken(mixpanleToken)
    ...
    func setReturnButton() {
        ...
        returnButton.addTarget(self, action: "returnMenuTouchDown:", for: UIControl.Event.touchDown)
        
        
        returnButton.addTarget(self, action: "returnMenuTouchCancel:", for: UIControl.Event.touchUpInside)
